...
public class Pre_ODM_Service extends SIPre {

	/** USING FOR SINGLE **/
	public Pre_ODM_Service(String rule, boolean isMergeData, String data, String siVersion, String processInfo, String dataSourceName, String logDataSource) {
	...
	/** USING FOR GROUP **/
	public Pre_ODM_Service(String rule, boolean isMergeData, String data, String siVersion, String processInfo, String dataSourceName, String logDataSource, SI_Log log) {
	...
	public String executeService(ServiceInfo serviceInfo) throws SIException {
		...
		case Version.v1_0:
			result = new com.service.impl.odm.v1_0.ODM_Service(super.service, super.data, super.isMergeData, super.siVersion, super.processDataSource, super.logDataSource, serviceInfo.getServiceConfig(), log).execute();
			break;
