...
public class Test_Services_GenDoc_Trangnmt {
	...
	public static void main(String[] args) throws Exception {
		...
		String dataSourceName = "SAALEM_51"; // SAALEM_UAT ; SAALEM_51
		...
		case Service.DXGN_BM35:			
			isMergeData = true;
			data = TestHelper.loadLosProcess("resources/20230605/BM35/process_data.json").toString();
		...
		case Service.BM122:			
			isMergeData = true;
			data = TestHelper.loadLosProcess("resources/20230605/BM122.json").toString();
			pre = new Pre_GenDoc_Service(service, isMergeData, data, bpmVersion, processInfo, dataSourceName, logDataSource);
			break;
