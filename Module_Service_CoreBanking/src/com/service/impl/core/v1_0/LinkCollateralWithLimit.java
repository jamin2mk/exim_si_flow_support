...
import com.model.link_collateral_with_limit.req.v_1_0.LinkCollateralWithLimitRequest;
import com.model.link_collateral_with_limit.res.v_1_0.Body;
import com.model.link_collateral_with_limit.res.v_1_0.LinkCollateralWithLimitResponse;
...
public class LinkCollateralWithLimit extends SI_Service {

	protected Body body = null;

	public LinkCollateralWithLimit(String data, boolean isMergeData,
		...
		super.invoker = new CoreBankingInvoker(serviceConfig,
				processDataSource, LinkCollateralWithLimitRequest.class,
				LinkCollateralWithLimitResponse.class, log);
	...
	public void check_invokeResult() throws SIException {
		...
		if (this.body.getColtrlLinkAddResponse() == null) {
