...
import com.model.createdepositcoltrl.req.v_1_0.CreateDepositColtrlRequest;
import com.model.createdepositcoltrl.res.v_1_0.Body;
import com.model.createdepositcoltrl.res.v_1_0.CreateDepositColtrlResponse;
...
public class CreateDepositColtrl extends SI_Service {

	protected Body body = null;

	public CreateDepositColtrl(String data, boolean isMergeData,
		...
		super.invoker = new CoreBankingInvoker(serviceConfig,
				processDataSource, CreateDepositColtrlRequest.class,
				CreateDepositColtrlResponse.class, log);
	...
	public void check_invokeResult() throws SIException {
		// TODO Auto-generated method stub
		String json = super.invoked_output.getAsJsonObject()
				.get("resultResponse").getAsString();
		String s = XmlHelper.fetchSubElementAsString(json, "Body");
		try {
		...
		if (this.body.getDepColtrlAddResponse() == null) {
			if (this.body.getError() != null) {
				String errorCode = "SV-98";
				String errorDesc = "";

				for (ErrorDetail er : this.body.getError()
						.getFiBusinessException().getErrorDetail()) {
					errorDesc += er.getErrorDesc() + " [Source: "
							+ er.getErrorSource() + "]; ";
				}
