...
public class Pre_GetExchangeRate extends SIPre{
	public Pre_GetExchangeRate(String data, String siVersion, String processInfo,
			String processDataSource, String logDataSource) {
		super(Service.GetExchangeRate, data, siVersion, processInfo,
	...
	public String executeService(ServiceInfo serviceInfo) throws SIException {
		...
		case Version.v1_0:
			result = new com.service.impl.core.v1_0.GetExchangeRate(super.data,
