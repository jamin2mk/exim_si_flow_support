...
public class Pre_GetLOSTD extends SIPre {
	public Pre_GetLOSTD(String data, String siVersion, String processInfo,
			String processDataSource, String logDataSource) {
		super(Service.GetLOSTD, data, siVersion, processInfo,
	...
	public String executeService(ServiceInfo serviceInfo) throws SIException {
		...
		case Version.v1_0:
			result = new com.service.impl.core.v1_0.GetLOSTD(super.data,
