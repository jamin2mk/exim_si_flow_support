package com.model.creditcardpublishsub.req.v_1_0;
...
@XmlRootElement(name = "CreditCardPublish_sub", namespace = "http://www.alsb.com/")
@XmlAccessorType(XmlAccessType.FIELD)
public class CreditCardPublishSubRequest {
	...
	public CreditCardPublishSubRequest() {
		super();
		// TODO Auto-generated constructor stub
	}

	public CreditCardPublishSubRequest(String flagStatus, String brcd,
			String seqno, String supseqno, String receiptdt, String fullnm,
			String prnnm, String birthdt, String sex, String idcard,
			String pmnaddr, String hmphoneno, String hmnationality,
			String ofcnm, String ofcaddr, String ofcphoneno, String mommdnm,
			...
			String recevcardAdd, String apprusrid, String brapprusrid,
			String email, String recevcardReason) {
		super();
