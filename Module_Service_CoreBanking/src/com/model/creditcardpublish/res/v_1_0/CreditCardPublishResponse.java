package com.model.creditcardpublish.res.v_1_0;
...
@XmlRootElement(name = "CreditCardPublishResponse", namespace = "http://www.alsb.com/")
public class CreditCardPublishResponse {
	...
	public CreditCardPublishResponse() {
		super();
		// TODO Auto-generated constructor stub
	}
	public CreditCardPublishResponse(String statusReturn,
			String descriptionMessage, String brcd, String seqno,
			String psncrd, String cprcrd, String ppscrlmt, String fullnm,
			String prnnm, String birthdt, String sex, String idcard,
			String pmnaddr, String yrsofrsd, String phoneno, String lvlofedu,
			String nationality, String mrtsts, String mommdnm, String housetp,
			String officenm, String officeaddr, String officetelno,
			String officepos, String wrksnr, String labourtp, String annual,
			String rcvloc, String settltp, String dracctno, String sttlwith,
			String accttp, String drratio, String receiptdt, String crdtp,
			String colltp, String crlmt, String expdt, String checked,
			String checkeddt, String approved, String approveddt,
			String status, String photofilename, String fullnm1,
			String idcard1, String ofcnm, String ofcaddr, String ofcphoneno,
			String hmaddr, String hmphoneno, String appdate, String crdtype,
			String crdvalidaty, String mobifon, String email, String other,
			String crdtypebank, String psncrdbank, String cprcrdbank,
			String note, String fileno, String contractno, String accountcd,
			String cardno, String brname, String mntcrdval, String issutp,
			String noteofho, String freetp, String anlfeereason, String compid,
			...
			String cshlmtofcust, String cshlmtofbnk, String crdlmtcd,
			String custtpcd, String custdtltpcd, String colldtltp,
			String cardnbr, String compcustseq, String statedt, String comptp,
			String compothr, String jobtp, String jobothr, String edcntp,
			String edcnothr, String addrtp, String addrothr, String depdno,
			String chkapp, String flg3dsce, String email3dsce,
			String tel13dsce, String tel23dsce, String tel33dsce,
			String chkecommerce, String purpose, String deptcd,
			String chkemail, String address1, String address2, String address3,
			String address4, String officeaddr1, String rcvcardaddr,
			String prdtcd, String vipflg, String cmpnynm,
			String usrnameXetduyet, String usrnameXetduyet01,
			String usrnameXetduyet02, String usrnameXetduyet03,
			String usrnameXetduyet04, String usrnameXetduyet05,
			String usrnameXetduyet06, String brcdDeptRcv,
			String brcdDeptNameRcv, String flgloan, String disbursementno,
			String disbursementamt, String eibChucvu, String recevcardMk,
			String recevcardAdd, String officeaddr2, String officeaddr3,
			String other1, String other2, String other3, String employid,
			String odaccount, String unststm, String recevcardReason) {
		super();
