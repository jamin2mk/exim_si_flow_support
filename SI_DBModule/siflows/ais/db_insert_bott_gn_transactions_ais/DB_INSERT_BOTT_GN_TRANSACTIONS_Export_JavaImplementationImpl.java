package siflows.ais.db_insert_bott_gn_transactions_ais;

import com.ibm.websphere.sca.ServiceManager;
import com.pre.impl.db.Pre_GR_GN_InsertTransaction;
...
public class DB_INSERT_BOTT_GN_TRANSACTIONS_Export_JavaImplementationImpl {
	 ...
	 * named "DB_INSERT_BOTT_GN_TRANSACTIONS_AIS".
	 * 
	...
	public String invoke(Boolean isMergeData, String iData, String siVersion,
			...
			Boolean insertProcess) {
		//TODO Needs to be implemented.
		return new Pre_GR_GN_InsertTransaction(insertProcess, iData, siVersion, processInfo, processDataSource, logDataSource).invoke();
	}
