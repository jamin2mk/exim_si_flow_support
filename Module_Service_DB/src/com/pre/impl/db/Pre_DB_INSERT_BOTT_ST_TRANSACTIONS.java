...
public class Pre_DB_INSERT_BOTT_ST_TRANSACTIONS extends SIPre{
	
	public Pre_DB_INSERT_BOTT_ST_TRANSACTIONS( boolean isMergeData,String data, String siVersion, String processInfo,String processDataSource, String logDataSource) {
		super(Service.DB_INSERT_BOTT_ST_TRANSACTIONS, data, siVersion, processInfo, processDataSource,logDataSource);
	...
	public Pre_DB_INSERT_BOTT_ST_TRANSACTIONS(boolean isMergeData,
			String data, String siVersion, String processInfo,
			String processDataSource, String logDataSource, SI_Log log) {

		super(Service.DB_INSERT_BOTT_ST_TRANSACTIONS, data, siVersion, processInfo, processDataSource,
				logDataSource, log);
		super.isMergeData = isMergeData;
		super.initLog();
		super.log.setSystem(SYS.BPM, null, SYS.DB);
	...
	public String executeService(ServiceInfo serviceInfo) throws SIException {
		...
		case Version.v1_0:
			result = new com.service.impl.db.v1_0.DB_INSERT_BOTT_ST_TRANSACTIONS(super.data,
