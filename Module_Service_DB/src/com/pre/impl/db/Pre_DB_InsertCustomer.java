...
public class Pre_DB_InsertCustomer extends SIPre {
	
	public Pre_DB_InsertCustomer(String procedure, boolean isMergeData,
	...
	public String executeService(ServiceInfo serviceInfo) throws SIException {
		...
		case Version.v1_0:
			result = new com.service.impl.db.v1_0.DB_InsertCustomer(super.data,
