...
public class Pre_DB_ServiceCache extends SIPre {

	/** USING FOR SINGLE **/
	public Pre_DB_ServiceCache(String procedure, boolean isMergeData, String data, String siVersion, String processInfo, String processDataSource, String logDataSource) {
	...
	/** USING FOR GROUP **/
	public Pre_DB_ServiceCache(String procedure, boolean isMergeData, String data, String siVersion, String processInfo, String processDataSource, String logDataSource, SI_Log log) {
	...
	public String executeService(ServiceInfo serviceInfo) throws SIException {
		...
		case Version.v1_0:
			result = new com.service.impl.db.v1_0.DB_ServiceCache(super.data, super.isMergeData, super.siVersion, super.processDataSource, super.logDataSource, serviceInfo.getServiceConfig(), log).execute();
			break;
