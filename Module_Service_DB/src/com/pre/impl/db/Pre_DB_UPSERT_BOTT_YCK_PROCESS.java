...
public class Pre_DB_UPSERT_BOTT_YCK_PROCESS extends SIPre{
	
	public Pre_DB_UPSERT_BOTT_YCK_PROCESS( boolean isMergeData,
			String data, String siVersion, String processInfo,
			String processDataSource, String logDataSource) {

		super(Service.DB_UPSERT_BOTT_YCK_PROCESS, data, siVersion, processInfo, processDataSource,
				logDataSource);
	...
	public String executeService(ServiceInfo serviceInfo) throws SIException {
		...
		case Version.v1_0:
			result = new com.service.impl.db.v1_0.DB_UPSERT_BOTT_YCK_PROCESS(super.data,
