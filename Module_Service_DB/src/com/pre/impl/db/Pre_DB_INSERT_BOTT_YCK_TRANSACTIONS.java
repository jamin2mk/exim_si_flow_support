...
public class Pre_DB_INSERT_BOTT_YCK_TRANSACTIONS extends SIPre{
	
	public Pre_DB_INSERT_BOTT_YCK_TRANSACTIONS( boolean isMergeData,
			String data, String siVersion, String processInfo,
			String processDataSource, String logDataSource) {

		super(Service.DB_INSERT_BOTT_YCK_TRANSACTIONS, data, siVersion, processInfo, processDataSource,
				logDataSource);
	...
	public String executeService(ServiceInfo serviceInfo) throws SIException {
		...
		case Version.v1_0:
			result = new com.service.impl.db.v1_0.DB_INSERT_BOTT_YCK_TRANSACTIONS(super.data,
