...
public class BM54 extends SI_Service {

	private GenDocInvoker genDocInvoker = null;
	private String docName = null;
	private String dependentRequired;
	
	public BM54(String docName, String data, boolean isMergeData, String siVersion, String processDataSource, String logDataSource, ServiceConfig serviceConfig, SI_Log log, String dependentRequired) {
	...
	public void businessMapping_Input() throws SIException {
		...
		////////////Change Num to Let//////////////
//		try {
//		JsonElement js1 = get_value_byDir(BO,"TT_SOANTHAO.TT_YC_HDTSBD[0].TONG_NV_BAODAM_TIEN");
//		String moneyText1 = MoneyHelper.readMoneyToText(js1.getAsString());
//		BO.addProperty("BY_TOTAL_GUARANTEE_OBLIGATIONS_3", moneyText1);
//		
//		JsonElement js2 = get_value_byDir(BO,"TT_SOANTHAO.TT_YC_HDTSBD[0].DS_BDS[0].TSTD_CCGCN.GIA_TRI");
//		String moneyText2 = MoneyHelper.readMoneyToText(js2.getAsString());
//		BO.addProperty("BY_ASSET_VALUE", moneyText2);
//		
//		} catch (Exception e) {
...
//		}
		...
		map.put("BY_ACREAGE", MoneyHelper.readMoneyToText(("ACREAGE").toString()));
		...
		map.put("RESULTS_LAND_USE", "QSSD.THOIHAN_SD_CONLAI");
		map.put("ORIGINAL_USE", "QSSD.NGUON_GOC");
		map.put("LIMITATIONS_USE",	"QSSD.HANCHE_SDD");
