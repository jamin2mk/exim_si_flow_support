...
public class BM100 extends SI_Service {

	private GenDocInvoker genDocInvoker = null;
	private String docName = null;
	private String dependentRequired;
	public BM100(String docName, String data, boolean isMergeData, String siVersion, String processDataSource, String logDataSource, ServiceConfig serviceConfig, SI_Log log, String dependentRequired) {
...
//		}
        ...
        map.clear();
		////////////////////////////////
		map.put("NOICAPID", "NOI_CAP, ISSUED_REGISTRATION_NUMBER_PTVT");
		BO = support.getMasterData(map,dirParent+".DS_PTVT[0]" , BO);
		map.clear();
		////////////////////////////////
		...
		//BO = toCheck("#.TT_SOANTHAO.TT_YC_HDTSBD[0].TT_BEN_BD.UYQUYEN_KY_HS", "BBD_KWNN", BO);
		///////////////CHECK-END/////////////////////////
