...
public class BM85 extends SI_Service {

	private GenDocInvoker genDocInvoker = null;
	private String docName = null;
	private String dependentRequired;
	public BM85(String docName, String data, boolean isMergeData, String siVersion, String processDataSource, String logDataSource, ServiceConfig serviceConfig, SI_Log log, String dependentRequired) {
...
//		map.put("VANG_VALUE_number", "VANG_SUM_VALUE");
//		BO = sum(map, TABLE_VANG, BO);
//		map.clear();
		//////////////////////////////////////
...
//						}else if(entry.getValue().equals("NGAY_PH") || entry.getKey().equals("NGAY_DAO_HAN")){
...
//								if(!valueJsonElement.getAsString().equals("0") || !valueJsonElement.getAsString().equals(""))							
//								   jo.addProperty(entry.getKey(), dateToString(valueJsonElement.getAsString()));
//							
//						}else {							
//							JsonElement valueJsonElement = je.getAsJsonObject().get(entry.getValue());
