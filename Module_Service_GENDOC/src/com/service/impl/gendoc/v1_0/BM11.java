...
public class BM11 extends SI_Service {
	
	private GenDocInvoker genDocInvoker = null;
	private String docName = null;
	private String dependentRequired;
	public BM11(String docName, String data, boolean isMergeData, String siVersion, String processDataSource, String logDataSource, ServiceConfig serviceConfig, SI_Log log, String dependentRequired) {
	...
	public void businessMapping_Input() throws SIException {
		...
		JsonArray TT_YC_HDTINDUNG = TT_SOANTHAO.get("TT_YC_HDTINDUNG").getAsJsonArray();
		
		// STARTING HANDLING DS_CHUYENKHOAN
		if(!TT_YC_HDTINDUNG.isEmpty()){
			JsonArray DS_PTHUC_CHUYENKHOAN = TT_YC_HDTINDUNG.getAsJsonArray().get(0).getAsJsonObject().get("DS_PTHUC_CHUYENKHOAN").getAsJsonArray();
			JsonArray tempInfo = new JsonArray();
			String TRANSFER_NAME = null;
			String TRANSFER_STK = null;
			String TRANSFER_SITE = null;
			String TRANSFER_MONEY = null;
			
			if(!DS_PTHUC_CHUYENKHOAN.isEmpty()) {
				for(JsonElement beInfoEle : DS_PTHUC_CHUYENKHOAN) {
					
					TRANSFER_NAME = beInfoEle.getAsJsonObject().has("TEN_THUHUONG") ? beInfoEle.getAsJsonObject().get("TEN_THUHUONG").getAsString(): "................";
					TRANSFER_STK = beInfoEle.getAsJsonObject().has("STK_THUHUONG") ? beInfoEle.getAsJsonObject().get("STK_THUHUONG").getAsString(): "................";
					TRANSFER_SITE = beInfoEle.getAsJsonObject().has("TCTD") ? convertMasterdataCodeToName("TCTD", beInfoEle.getAsJsonObject().get("TCTD").getAsString()): "................";
					TRANSFER_MONEY = beInfoEle.getAsJsonObject().has("SOTIEN") ? beInfoEle.getAsJsonObject().get("SOTIEN").getAsString(): "................";
	...
	public void businessMapping_Output() throws SIException {
		...
		LGIssuesHandling.CheckBoxExchange(inputData, "CASH");
		LGIssuesHandling.CheckBoxExchange(inputData, "TRANSFER");
