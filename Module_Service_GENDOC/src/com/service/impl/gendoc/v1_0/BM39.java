...
public class BM39 extends SI_Service {
	
	private GenDocInvoker genDocInvoker = null;
	private String docName = null;
	private String dependentRequired;
	
	public BM39(String docName, String data, boolean isMergeData, String siVersion, String processDataSource, String logDataSource, ServiceConfig serviceConfig, SI_Log log, String dependentRequired) {
	...
	public void businessMapping_Output() throws SIException {
		...
		if(!inputDataCFG.get("TABLE_TSBD").getAsJsonArray().isEmpty()){
			...
			for(JsonElement BDSEle : inputDataCFG.get("TABLE_TSBD").getAsJsonArray()) {
				...
				TABLE_VALUE_TEMP.addProperty("PROPERTY_DOC_NUMBER", QSSD.has("TEN_GIAY_CN") && !QSSD.get("TEN_GIAY_CN").isJsonNull() ? QSSD.get("SO_GCN").getAsString():"");
