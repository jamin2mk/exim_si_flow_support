...
public class BM28 extends SI_Service {

	private GenDocInvoker genDocInvoker = null;
	private String docName = null;
	private String dependentRequired;
	public BM28(String docName, String data, boolean isMergeData, String siVersion, String processDataSource, String logDataSource, ServiceConfig serviceConfig, SI_Log log, String dependentRequired) {
	...
	public void businessMapping_Input() throws SIException {
        ...
        BO = support.getMasterData(map,"#.TT_SOANTHAO.TT_BEN_BD.KH_CN" , BO);
        map.clear();
        //////////////////////////////////
        map.put("NOICAPID", "NOI_CAP, BTC_CN_COUPLE_ISSUED_BY");
        BO = support.getMasterData(map,"#.TT_SOANTHAO.TT_BEN_BD.TT_DINHDANH[0]" , BO);
        map.clear();
        ////////////////////////////////
        map.put("ONGBA", "ONG_BA, NHP_GRANDPARENTS");
        BO = support.getMasterData(map,"#.TT_SOANTHAO.TT_BEN_BD.TT_NGUOIHONPHOI" , BO);
        map.clear();
        //////////////////////////////////
        map.put("NOICAPID", "NOI_CAP, NHP_ISSUED_BY");
        BO = support.getMasterData(map,"#.TT_SOANTHAO.TT_BEN_BD.TT_NGUOIHONPHOI.TT_DINHDANH[0]" , BO);
        map.clear();
        ////////////////////////////////
...
//        map.clear();
        ...
        BO= support.getAddress(BO,"#.TT_SOANTHAO.TT_BEN_BD.TT_LIENLAC" ,"BTC_CN_COUPLE_PER_ADDRESS", "BTC_CN_COUPLE_CONT_ADDRESS");
        BO= support.getAddress(BO,"#.TT_SOANTHAO.TT_BEN_BD.TT_NGUOIHONPHOI.TT_LIENLAC" ,"NHP_PER_ADDRESS", "NHP_CONT_ADDRESS");
         /////////////////MASTER DATA-END///////////////////////////	
		...
		BO = support.toCheck("#.TT_SOANTHAO.TT_BEN_BD.YC_NGUOIHONPHOI", "MARRIAGE_SIGNING", BO);
		BO = support.toCheck("#.TT_SOANTHAO.TT_BEN_BD.DONG_SO_HUU", "IS_DSH", BO);
		BO = support.toCheck("#.TT_SOANTHAO.TT_BEN_BD.UYQUYEN_KY_HS", "BBD_KWNN", BO);
		///////////////CHECK-END/////////////////////////
		...
		String[] radio_CQ_GIAIQUYET_TT= {"PREVAILING_REGULATIONS"};
		BO = support.toRadio(dirParent+".COQUAN_GIAIQUYET",radio_CQ_GIAIQUYET_TT, BO, "CHECK");
   ...
   ///////////////TABLE START////////////////////////////
    ...
    ///////////////TABLE END//////////////////////////////
		...
		//////////////////////////////////////
		  ...
		  JsonArray TABLE_DSH = support.getTable(map, "#.TT_SOANTHAO.TT_BEN_BD.DS_DONGSOHUU", BO);
		  BO.addProperty("TABLE_DSH", TABLE_DSH.toString());
		  map.clear();
		  //BO = getListDSH(TABLE_DSH, BO);
        //////////////CUSTOME FIELD-END////////////////////
	}
//	private JsonObject getListDSH(JsonArray TABLE_DSH, JsonObject BO) throws SIException{
//		
//		String template = "%s: %s , sinh năm: %s CMND/CCCD/Hộ chiếu số : %s, nơi cấp %s \n Địa chỉ thường trú: %s \n Địa chỉ liên lạc : %s  Điện thoại : %s \n \n";
//		String result = "";
//		for(JsonElement je: TABLE_DSH){
//			if(!je.isJsonObject()) continue;
//			JsonObject jo = je.getAsJsonObject();
//			result += String.format(template, jo.get("HDBD_556"), jo.get("HDBD_127"), jo.get("HDBD_129"), jo.get("HDBD_395"), jo.get("HDBD.398"), jo.get("HDBD_348_tt"), jo.get("HDBD_348_ll"), jo.get("HDBD_128"));
//		}
//				
//		BO.addProperty("TABLE_DSH_INFO", result);
//		return BO;
//	}
