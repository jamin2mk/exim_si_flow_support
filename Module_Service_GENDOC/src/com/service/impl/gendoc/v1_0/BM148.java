...
public class BM148 extends SI_Service {

	private GenDocInvoker genDocInvoker = null;
	private String docName = null;
	private String dependentRequired;
	public BM148(String docName, String data, boolean isMergeData, String siVersion, String processDataSource, String logDataSource, ServiceConfig serviceConfig, SI_Log log, String dependentRequired) {
...
//		}
		...
		map.put("LOAIID", "LOAI_ID, ID_TYPE_DN|ID_TYPE_CN");
		BO = support.getMasterData(map,"#.TT_BAO_CAO.TT_CTD_KH.TT_DINHDANH[0]" , BO);
...
//		BO = support.toCheck(dirParent+".NGAY_HH_CTHE", "BL_THE_EXACT_DAY", BO);
		BO = support.toCheck(dirParent+".SONGAY", "NO_DAYS_1", BO);
//		BO = support.toCheck(dirParent+".CUTHE_NGAYHETHIEULUC", "SPECIFIC_EXPIRY_DATE_1", BO);
//		BO = support.toCheck("#.DEXUAT_STHAO_GN.IS_BAOLANH", "GUARANTEE", BO);
		BO = support.toCheck(dirParent+".NGAY_HH_SUKIEN", "GNBL_EVENT_1", BO);		
		BO = support.toCheck(dirParent+".SONGAY", "BL_NO_DATE_1", BO);
