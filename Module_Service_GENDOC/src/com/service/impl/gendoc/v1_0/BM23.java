...
public class BM23 extends SI_Service {

	private GenDocInvoker genDocInvoker = null;
	private String docName = null;
	private String dependentRequired;
	public BM23(String docName, String data, boolean isMergeData, String siVersion, String processDataSource, String logDataSource, ServiceConfig serviceConfig, SI_Log log, String dependentRequired) {
...
//		}
		...
		BO = support.toRadio(dirParent+".KY_HAN_LAI",radio_KY_HAN_LAI, BO, "CHECK");
		
		String[] radio_KY_HAN_GOC= {"MULTIPLE_PAYMENT_MATERIALS","PAY_ONE_PROFIT_G","OTHER_PAYMENT_MATERIALS"};
		BO = support.toRadio(dirParent+".KY_HAN_GOC",radio_KY_HAN_GOC, BO, "CHECK");
...
//		JsonArray TABLE_GTCG = support.getTable(map,dirParent+ ".DS_TIEN_VANG_GTCG[0].TT_TGTCG", BO, "DS_TIEN_VANG_GTCG");
...
//		BO = support.sum(map, TABLE_GTCG, BO);
		map.clear();
		//////////////////////////////////////
