...
public class BM64 extends SI_Service {

	private GenDocInvoker genDocInvoker = null;
	private String docName = null;
	private String dependentRequired;
	
	public BM64(String docName, String data, boolean isMergeData, String siVersion, String processDataSource, String logDataSource, ServiceConfig serviceConfig, SI_Log log, String dependentRequired) {
...
//		JsonArray DS_BDS = TT_YC_HDTSBD.get(0).getAsJsonObject().get("DS_BDS").getAsJsonArray();
//		JsonObject QSH_SD_DDKD = DS_BDS.get(0).getAsJsonObject().get("QSH_SD_DDKD").getAsJsonObject();
//		JsonArray DS_NH_KINHDDOANH = QSH_SD_DDKD.get("DS_NH_KINHDDOANH").getAsJsonArray();
//		JsonArray TABLE_BM64_ARRAY = new JsonArray();
//		JsonObject TABLE_BM64 = new JsonObject();
//		if(DS_NH_KINHDDOANH != null && DS_NH_KINHDDOANH.size() > 0){
//			int stt = 1;
//			for (JsonElement table : DS_NH_KINHDDOANH) {
//				TABLE_BM64.addProperty("STT", stt);
//				TABLE_BM64.addProperty("BUSINESS_SECTOR", table.getAsJsonObject().get("NGANHHANG_KD").getAsString());
//				TABLE_BM64.addProperty("BUSINESS_POINT_CODE", table.getAsJsonObject().get("MA_SO").getAsString());
//				TABLE_BM64.addProperty("SIZE", table.getAsJsonObject().get("KICH_THUOC").getAsString());
//				TABLE_BM64.addProperty("ACREAGE_2", table.getAsJsonObject().get("DIEN_TICH").getAsString());
//				TABLE_BM64.addProperty("COEFFICIENT", table.getAsJsonObject().get("HESO_TL").getAsString());
//				TABLE_BM64_ARRAY.add(TABLE_BM64);
//				BO.addProperty("TABLE_BM64", TABLE_BM64_ARRAY.toString());
//				stt++;
//			}	
//	}
//		map.put("TSBD_CONTACT", "SO_HD");
//		map.put("TSBD_DATE", "NGAY_GOP_VON");
//		JsonArray TABLE_MOTA = SupBM.getTable(map, ".TT_SOANTHAO.TT_YC_HDTSBD[0].DS_BDS[0].QSH_SD_DDKD", BO);
//		BO.addProperty("TABLE_MOTA", TABLE_MOTA.toString());
//		map.put("BUSINESS_SECTOR", "NGANHHANG_KD");
//		map.put("BUSINESS_POINT_CODE", "MA_SO");
//		map.put("SIZE", "KICH_THUOC");
//		map.put("ACREAGE_2", "DIEN_TICH");
//		map.put("COEFFICIENT", "HESO_TL");
//		JsonArray TABLE_MOTA2 = SupBM.getTable(map, "#.TT_SOANTHAO.TT_YC_HDTSBD[0].DS_BDS[0].QSH_SD_DDKD.DS_NH_KINHDDOANH", BO);
//		BO.addProperty("TABLE_MOTA", TABLE_MOTA2.toString());
//		map.clear();
		...
		map.put("TSBD_CONTACT", "QSH_SD_DDKD.SO_HD");
		map.put("TSBD_DATE", "QSH_SD_DDKD.NGAY_GOP_VON");
		map.put("BUSINESS_SECTOR", "QSH_SD_DDKD.DS_NH_KINHDDOANH.NGANHHANG_KD");
		map.put("BUSINESS_POINT_CODE", "QSH_SD_DDKD.DS_NH_KINHDDOANH.MA_SO");
		map.put("SIZE", "QSH_SD_DDKD.DS_NH_KINHDDOANH.KICH_THUOC");
		map.put("ACREAGE_2", "QSH_SD_DDKD.DS_NH_KINHDDOANH.DIEN_TICH");
		map.put("COEFFICIENT", "QSH_SD_DDKD.DS_NH_KINHDDOANH.HESO_TL");
