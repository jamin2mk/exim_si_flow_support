...
public class BM68 extends SI_Service {

	private GenDocInvoker genDocInvoker = null;
	private String docName = null;
	private String dependentRequired;
	
	public BM68(String docName, String data, boolean isMergeData, String siVersion, String processDataSource, String logDataSource, ServiceConfig serviceConfig, SI_Log log, String dependentRequired) {
	...
	public void businessMapping_Input() throws SIException {
		...
		try {
			JsonElement js = get_value_byDir(BO,dirParent+".DS_BDS[0].TSTD_CCGCN.GIA_TRI");
			String moneyText = MoneyHelper.readMoneyToText(js.getAsString());
		...
		JsonArray TABLE_DSH = SupBM.getTable(map, "#.TT_SOANTHAO.TT_YC_HDTSBD[0].TT_BEN_BD.DS_DONGSOHUU", BO);
		...
		BO.addProperty("BY_MBCH_TOTAL_AREA", "");
