...
public class BM49 extends SI_Service {
	
	private GenDocInvoker genDocInvoker = null;
	private String docName = null;
	private String dependentRequired;
	
	public BM49(String docName, String data, boolean isMergeData, String siVersion, String processDataSource, String logDataSource, ServiceConfig serviceConfig, SI_Log log, String dependentRequired) {
	...
	public void businessMapping_Input() throws SIException {
		...
		BO.addProperty("HDBD_NAME_DETAILS", "");
	...
	public void businessMapping_Output() throws SIException {
		...
		LGIssuesHandling.GetNumberFormater(inputData, "MBCH_TOTAL_AREA", "VN", 2);
		LGIssuesHandling.GetNumberFormater(inputData, "MBCH_VALUE_TSBD", "VN", 0);
		...
		LGIssuesHandling.GetByNumberInWords(inputData, "MBCH_TOTAL_AREA", "BY_MBCH_TOTAL_AREA");
		LGIssuesHandling.GetByNumberInWords(inputData, "MBCH_VALUE_TSBD", "BY_MBCH_VALUE_TSBD");
